document.querySelector("form").addEventListener("submit", async (e) => {
    ...
    const webhookURL = "https://discord.com/api/webhooks/1390701162277109822/NXCkdNi38paheyk1CQifk468vJgaFK_qDRMG-MnEdUVWCSzKtqC5LPUeT_PGmWi61Gze"; // Remplacez par votre Webhook Discord

    const data = {
        username: 'Ruиgis Liиεr | Recrutement',
        avatar_url: 'https://imgur.com/8TbYZfq.png',
        content: "<@&1358963787964878919>\n- 📩 **Un nouveau formulaire a été soumis !**",
        embeds: [
            {
